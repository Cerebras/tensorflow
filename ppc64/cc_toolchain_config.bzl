...
def _impl(ctx):
    ...
    target_system_name = "powerpc64le"
    ...
    if (ctx.attr.cpu == "local"):
        target_libc = "local"
    elif (ctx.attr.cpu == "powerpc64le"):
        target_libc = "ppc64le"
    else:
        fail("Unreachable")

    if (ctx.attr.cpu == "powerpc64le" or
        ctx.attr.cpu == "local"):
        compiler = "compiler"
    else:
        fail("Unreachable")
    ...
    undefined_dynamic_feature = feature(
        ...
        flag_sets = [
            flag_set(
                ...
                flag_groups = [flag_group(flags = ["-undefined"])],
            ),
        ],
    )
    ...
    elif (ctx.attr.cpu == "powerpc64le" or
          ctx.attr.cpu == "local"):
    ...
    if (ctx.attr.cpu == "local"):
        tool_paths = [
            ...
            tool_path(name = "compat-ld", path = ctx.attr.host_compiler_prefix + "/powerpc64le-buildroot-linux-gnu-ld"),
        ...
        tool_paths = [
            tool_path(name = "gcc", path = ctx.attr.host_compiler_path),
            tool_path(name = "ar", path = ctx.attr.host_compiler_prefix + "/powerpc64le-buildroot-linux-gnu-ar"),
            tool_path(name = "compat-ld", path = ctx.attr.host_compiler_prefix + "/ld"),
            tool_path(name = "cpp", path = ctx.attr.host_compiler_prefix + "/powerpc64le-buildroot-linux-gnu-cpp"),
            tool_path(name = "dwp", path = ctx.attr.host_compiler_prefix + "/powerpc64le-buildroot-linux-gnu-dwp"),
            tool_path(name = "gcov", path = ctx.attr.host_compiler_prefix + "/powerpc64le-buildroot-linux-gnu-gcov"),
            tool_path(name = "ld", path = ctx.attr.host_compiler_prefix + "/powerpc64le-buildroot-linux-gnu-ld"),
            tool_path(name = "nm", path = ctx.attr.host_compiler_prefix + "/powerpc64le-buildroot-linux-gnu-nm"),
            tool_path(name = "objcopy", path = ctx.attr.host_compiler_prefix + "/powerpc64le-buildroot-linux-gnu-objcopy"),
            tool_path(name = "objdump", path = ctx.attr.host_compiler_prefix + "/powerpc64le-buildroot-linux-gnu-objdump"),
            tool_path(name = "strip", path = ctx.attr.host_compiler_prefix + "/strip"),
        ]
    else:
        fail("Unreachable")
...
cc_toolchain_config = rule(
    ...
    attrs = {
        "cpu": attr.string(mandatory = True, values = ["powerpc64le", "local", "x64_windows"]),
